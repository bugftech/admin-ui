          ...
          <v-tabs-window-item :value="2">
            <v-row>
              <v-col cols="12" v-if="order">
                <v-toolbar color="indigo" class="rounded-t-lg">
                  ...
                  <v-spacer> </v-spacer>
                  <v-toolbar-items>
                    <v-btn size="small" @click="updateStatus(4)">去退款</v-btn>
                    <v-btn size="small" @click="updateStatus(5)">无效订单</v-btn>
                  </v-toolbar-items>
                </v-toolbar>
                <v-stepper-vertical v-model="step">
                  ...
                  >
                    ...
                    <v-card variant="flat" class="border" v-if="order">
                      ...
                      <v-divider />
                      <v-card-actions>
                        <v-btn @click="step++" size="small" color="indigo" variant="tonal">
                          下一步
                        </v-btn>
                      </v-card-actions>
                    </v-card>
                  ...
                  >
                    <template v-slot:title>
                      <div class="text-subtitle-2 font-weight-bold">未发货</div>
                    </template>
                    <v-card variant="flat" class="border">
                      ...
                      >
                        <template v-slot:text>
                          <div class="text-caption">虚拟订单不需要发货信息</div>
                        </template>
                      </v-alert>
                      <v-card-text>
                        <v-row dense>
                  ...
                  >
                    <template v-slot:title>
                      <div class="text-subtitle-2 font-weight-bold">已发货</div>
                    </template>
                    <v-card variant="flat" class="border">
                  ...
                  >
                    <template v-slot:title>
                      <div class="text-subtitle-2 font-weight-bold">已完成</div>
                    </template>
                    <v-divider />
                    <v-card-actions>
                      <v-btn @click="step--" size="small" color="indigo">
                  ...
                  >
                    <template v-slot:title>
                      <div class="text-subtitle-2 font-weight-bold">已关闭</div>
                    </template>
